...
public class Config {
    ...
    public static HashMap<String, Org> getConfigure() throws MalformedURLException, InvalidArgumentException {
        ...
        org1.addPeerLocation("peer0.center.boot.com", "grpc://127.0.0.1:11051");
        org1.addPeerLocation("peer1.center.boot.com", "grpc://127.0.0.1:11053");
        org1.addOrdererLocation("orderer.boot.com", "grpc://127.0.0.1:7050");
        ...
        org2.addPeerLocation("peer0.center.boot.com", "grpc://127.0.0.1:14052");
        org2.addPeerLocation("peer1.center.boot.com", "grpc://127.0.0.1:14054");
        org2.addOrdererLocation("orderer.boot.com", "grpc://127.0.0.1:7050");
