...
public class Org{
    ...
    private RightUser admin;
    private String caLocation;
    private Properties caProperties = null;

    private RightUser peerAdmin;
    ...
    public RightUser getAdmin() {
        return admin;
    }

    public void setAdmin(RightUser admin) {
        this.admin = admin;
    }
    ...
    public void addUser(RightUser user) {
    ...
    public RightUser getPeerAdmin() {
        return peerAdmin;
    }

    public void setPeerAdmin(RightUser peerAdmin) {
